            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="wsus__pro_page_bammer vendor_det_banner">
                        <img src="{{asset('frotend/images/vendor_details_banner.jpg')}}" alt="banner" class="img-fluid w-100">
                                    ...
                                    <div class="col-xl-3 col-sm-6">
                                        <div class="wsus__product_item">
                                            ...
                                            <ul class="wsus__single_pro_icon">
                                                ...
                                                <li><a href="javascript:;" class="add_to_wishlist" data-id="{{$product->id}}"><i class="far fa-heart"></i></a></li>
