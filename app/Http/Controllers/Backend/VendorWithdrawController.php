...
class VendorWithdrawController extends Controller
{
    ...
    /**
     ** عرض طلب السحب للبائع
     ** Display a withdraw request for the vendor.
     * @param VendorWithdrawDataTable $dataTable
     */
    public function index(VendorWithdrawDataTable $dataTable)
    {
        $totalEarnings = OrderProudct::where('vendor_id', Auth::user()->id)
    ...
    /**
     **عرض نموذج طلب سحب جديد
     ** Show the form for creating a new withdraw request.
     * @return View
     */
    ...
    /**
     **انشاء طلب سحب جديد 
     ** Store a newly created withdraw request in storage.
    ...
    /**
     ** عرض طريقة السحب المحددة
     ** Display the specified withdraw method.
     * @param string $id
     * @return Response
     */
    ...
    /**
     ** عرض طلب سحب معين
     ** Display the specified withdraw request.
     * @param string $id
     * @return Response
     */
