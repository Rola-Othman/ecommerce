...
class AdvertisementController extends Controller
{
    ...
    /**
     ** عرض صفحة الإعلانات
     ** Display an advertisements page
     */
...
// dd($homepage_secion_banner_two);
      ...
      //  dd($homepage_secion_banner_three);
    ...
    public function homepageBannerSecionOne(Request $request)
    {
        ...
        $imagePath = $this->uploadFile($request->file('banner_image'));
    ...
    public function homepageBannerSecionTwo(Request $request)
    {
        ...
        /** Handle the image upload */
        $imagePath = $this->uploadFile($request->file('banner_one_image'));

        $imagePathTwo = $this->uploadFile($request->file('banner_two_image'));
    ...
    public function homepageBannerSecionThree(Request $request)
    {
        ...
        $imagePath = $this->uploadFile($request->file('banner_one_image'));
        $imagePathTwo = $this->uploadFile($request->file('banner_two_image'));
        $imagePathThree = $this->uploadFile($request->file('banner_three_image'));
