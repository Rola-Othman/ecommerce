...
class UserVendorReqeustController extends Controller
{
    use FileUpload;
    /**
     ** عرض نموذج ان اصبح بائع 
     ** Display a form to become a vendor
     * @return View
     */
    ...
    public function create(Request $request)
    {
        ...
        $imagePath = $this->uploadFile($request->file('shop_image'));
        ...
        flash()->success('Submitted successfully please wait for approve.');
        return redirect()->back();
    }
}
