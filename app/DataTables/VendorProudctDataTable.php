...
class VendorProudctDataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<VendorProudct> $query Results from query() method.
     */
...
//                   <li><a class="dropdown-item has-icon" href="'.route('vendor.products-variant.index', ['product' => $query->id]).'"> Variants</a></li>
     ...
     *
     * @return QueryBuilder<VendorProudct>
     */
    public function query(Proudct $model): QueryBuilder
    {
    ...
    {
        return 'VendorProudct_' . date('YmdHis');
    }
}
