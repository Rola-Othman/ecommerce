    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                                $veriantItems = "<a href='" . route('admin.products-variant.edit', $query->id) . "' class='btn btn-info mr-2'><i class='far fa-edit'></i> Variant Items</a>";

            //    $veriantItems = "<a href='" . route('admin.products-variant.edit', ['productId' => request()->product, 'variantId' => $query->id]) . "' class='btn btn-info mr-2'><i class='far fa-edit'></i> Variant Items</a>";
